...
The best performed checkpoint can be downloaded from [here](https://drive.google.com/drive/folders/10NbIMP5a6PWkZ97Ta9lggAvla3XEh8oa?usp=drive_link)(Please note, this one performs a little better than the results presented in our publication, but we decided to respect our published version and didn't update further in the manuscript.)
